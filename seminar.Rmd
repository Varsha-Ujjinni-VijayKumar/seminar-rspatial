...
```{r temperature-code, eval = F, echo = T, attr.output='style="max-height: 200px;"'}
library(raster)
library(ggplot2)
library(magrittr)
library(sf)
...
```{r elevation-code, eval = F, echo = T, attr.output='style="max-height: 200px;"'}
...
```{r malaria-code, eval = F, echo = T, attr.output='style="max-height: 200px;"'}
